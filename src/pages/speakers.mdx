...
import chrisImage from "../components/SpeakerImages/chris-steele";
...
import georgeImage from "../components/SpeakerImages/george";
...
import nelidaImage from "../components/SpeakerImages/nelida-velazquez";
import nicoleImage from "../components/SpeakerImages/nicole";
import pankajImage from "../components/SpeakerImages/pankaj";
...
import dimitryImage from "../components/SpeakerImages/dimitry";
import chrisHollandImage from "../components/SpeakerImages/chrisholland";
import margeauxImage from "../components/SpeakerImages/margeaux";
...
<Speaker name="Chris Steele" Image={chrisImage} talk={{ title: "Jasmine testing to the rescue!", 
description: "JavaScript testing. You either love it or hate it. There is very little in between in most cases; especially when you are asked to incorporate it in an existing application that was not designed with testing in mind. It can be difficult to know how or where to even start! The good news is it is much easier than most realize. By using Jasmine, I\'ll guide you through how easy it can be to hit the ground running!" }} 
twitter="csteele86" 
linkedin="christopherbsteele" 
company="Improving Enterprises" 
bio="Chris Steele grew up in Pataskala, OH and received his Bachelors in Computer Information Systems (CIS) at DeVry University and his Masters in Information Systems Management (MISM) at Keller Graduate School of Management all while working full-time. Now with 9 years of industry experience, Chris is a Director of Consulting for Improving Enterprises where he is primarily a Full-Stack developer. Chris passions include web technologies, professional development, teaching,growing,mentoring others, fitness, and his family of 6."
 /> 
...
bio="Chris Holland leads a small Software Engineering Team at an HR company. Throughout a career spanning more than 20 years, Chris has held Sr. Engineering and Leadership roles for small and large successful publicly-traded companies such as EarthLink and Internet Brands, serving business models across Content, Commerce, Travel & Finance on a wide variety of technology stacks including PHP,LAMP, Java,J2EE and C# and .Net, catering to audiences over 100 million monthly visitors."
 ...
 <Speaker name="Dmitry Vinnik" Image={dimitryImage} talk={{ title: "Uphill Battle Of Mobile Visual Regression", 
description: "There are many types of testing companies need to perform in order to have confidence in their product: security testing, integration testing, system testing, performance testing, and more. Often, Mobile Developers focus on ensuring that main End-to-End flows of their applications work by relying on frameworks like Appium, or Robotium. However, in Mobile domain, Visual Testing is essential as mobile devices differ drastically in capabilities, display dimensions and even operating systems.Visual regression testing targets specific areas of visual concepts like layouts, responsive design, graphics, and CSS. Because modern mobile applications are built as hybrid and native applications, there is no way to scale this sort of testing using manual resources; hence, Visual test automation should be a crucial piece of testing stack.In this talk, the audience will learn about major Visual Testing Frameworks targeting both responsive web applications, and native mobile applications. " }} 
...
<Speaker name="'Tine Jekis" Image={christineImage} talk={{ title: "Curriculum to Command Line: Why Teachers Make Awesome Coders, and What Your Team Can Learn from Them", 
...
<Speaker name="Margeaux DeRaedt" Image={margeauxImage} talk={{ title: "An Aspiring Developers Notes on Being a Mentor", 
description: "In this session, you will learn how to be an effective mentor from the perspective of an aspiring developer.As an experienced developer, you may have found yourself in a position of influence over young developers. You may know just what to do, or you may feel uncertain of how to play the mentor role. Additionally, good developers are in high demand! What can we do to ensure a new generation of effective devs?  To change your corner of the world, you need to take time and learn to be an effective mentor to others. This session is a guideline to what an effective mentor and mentee relationship looks like. Topics covered will include soft skills, practical advice, and how to instill the values of integrity and lifelong learning in a young developer. If you have found yourself in a mentor position or are looking to become one, this session is for you." }} 
twitter="" 
linkedin="margeaux-deraedt-307079182" 
company="Kinship" 
bio="Margeaux DeRaedt is a student at the University of Toledo, majoring in Computer Science Engineering. Currently, Margeaux is an apprentice at Kinship, where she is learning to become a master in React and humbly figuring out how to work with APIs. In her free time, Margeaux enjoys playing guitar, gaming, and reading."
 />
...
<Speaker name="Nelida Velazquez" Image={nelidaImage} talk={{ title: "Embrace your Legacy… Code", 
description: "What is your reaction when you hear the words legacy code? If it is to run away screaming, you are not alone.Developers often tend to focus on the negative aspects of legacy codebases. We think of legacy codebases as boring, outdated, difficult to work with, and overwhelming, and we overlook the opportunity to learn from them. These codebases are full of valuable knowledge and they can teach us to be disciplined, empathetic, and persistent.In this talk I will share ways to approach legacy code with a more constructive attitude and focus on growth. We will also look at techniques to help us better understand and improve our legacy codebases.It is my hope that you will leave feeling excited and empowered to discover the hidden gems that your legacy codebase has to offer." }} 
twitter="tolkiana" 
linkedin="nelida-velazquez-56967014" 
company="Detroit Labs" 
bio="Nelida is an Application developer who has a passion for tacos and code. She’s been developer for over 10 years and when not coding, she likes to read, travel and attend conferences around the world."
 />
...
bio="Nicole Archambault is a Boston area front-end web developer, coding career change coach, and EdTech entrepreneur. She is the founder of La Vie en Code, dedicated to new self-taught web developers.Her entire career is centered on optimizing the experience of those who choose to teach themselves programming skills in lieu of a more traditional academic setting, or bootcamp. She has received several awards and recognitions through her work in the developer community, including freeCodeCamp Top Contributor, and has been featured as a Treehouse Success Story. She has been teaching everything she knows via her course + coaching program, 30 Days to Web Development, the La Vie en Code blog, and the La Vie en Code podcast."
 ...
 <Speaker name="Pankaj Parkar" Image={pankajImage} talk={{ title: "Demystifying Change Detection in Angular", 
description: "Angular is one of the extraordinary javascript frameworks available in the market, because it have all the features required for the web development out of the box. The change detection system is at heart of framework, it essentially helps to update bindings on a page in efficient manner. In this session, we will learn about change detection in detail, in a simple and easy to understand way. And gradually we will move on to the behind the scenes part of it." }} 
twitter="pankajparkar" 
linkedin="pankajparkar" 
company="Synerzip" 
bio="Pankaj is currently working as a Technical Lead at Synerzip, Pune. He has been into web application development from last 6 years. Worked on different front-end technologies based on Javascript (like AngularJS, Angular, React, emberjs, etc) and backend technologies (like .Net, C#, SQL, nodejs, etc). He is passionate about knowledge sharing, hence most of the time you will find him helping people on StackOverflow for Angular questions.I consistently contribute to community by speaking at events, writing blogs, answering questions on stackoverflow, opensource contribution, etc. Beside that He is a part of Microsoft MVP and Google Developer Expert program."
 />
